...
const Me = () => {
  ...
  return (
    <div>
      ...
      >
        <div className="">
          <p className=" text-[#023E8A] text-center py-3 pt-16 text-2xl font-bold">
            What is Pay ID?
          </p>

          <p className=" text-center px-3 py-12 pl-8">
            A Pay Id is a code each user has as an identity for transactions
          </p>

          <div className="flex justify-center">
            <Button
              className="bg-[#0077b6] p-3 text-center w-[300px] h-[50px] rounded-lg mt-[3rem] text-white "
              value="Generate Pay Id"
            />
          </div>
          <p
            onClick={closePayIdContainer}
            className="text-[#023e8A] font-bold absolute bottom-10 right-4 "
          >
            close
          </p>
        </div>
      ...
      <div>
        <div className="bg-[#023E8A] text-white h-[200px]">
          ...
          <div className="ml-5 pt-4">
            <p className="font-bold  text-2xl">
              {eyeIconIsClicked ? userAmount : "****"}
            </p>
          </div>
        </div>

        <div className="mt-3 pl-3 bg-slate-200 w-[90%] m-auto h-[130px] pt-5 rounded-lg">
          <div className=" flex pl-5">
            <div className="flex gap-3">
              ...
              <p className="text-[16px] font-bold">Transaction History</p>
            </div>
        ...
        <div className="mt-3 pl-3 bg-slate-200 w-[90%] m-auto h-[220px] pt-3 rounded-lg">
          <div className=" flex pt-4 pl-5">
            <div className="flex gap-3 ">
              ...
              <p className="text-[16px] font-bold">DPay USSD</p>
            </div>
          ...
          <div className=" flex pt-8 pl-5">
            <div className="flex gap-3 ">
              ...
              <p className="text-[16px] font-bold">Refer Friends</p>
            </div>
        ...
        <div className="pb-[12rem] ml-[2rem] mt-6">
          <Link href="/Login">
            <Button
              className="bg-[#0077b6] w-[90%] text-lg  border-black h-[60px] text-white text-center rounded-lg"
              value="Login"
            />
          </Link>
        </div>
