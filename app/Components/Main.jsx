...
const Main = () => {
  ...
  return (
    <div>
      ...
      <div className="transfer-section w-[95%] h-[110px]  py-4 ml-2 rounded-lg bg-white mt-6">
      ...
      <div className="services w-[95%] h-[200px] grid grid-cols-3 gap-4 px-3 pt-6  bg-white mt-4 pl-14 ml-2 rounded-lg ">
